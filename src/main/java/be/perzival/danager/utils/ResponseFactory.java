...
public class ResponseFactory {
    ...
    public final static  MessageBuilder getEmbedResponse(CommonResponse commonResponse) {
    ...
    public final static MessageBuilder getEmbedResponse(ResponseType responseType, String message) {
